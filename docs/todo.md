...
| MSG-1 | Full 技术方案：inline ask card、非阻塞 waiting_user 恢复、BUG-30 TeamResult 类型化 | youren + agent | design draft，待评审（[需求包](requirements/active/MSG-1-message-typing/index.md)） |
