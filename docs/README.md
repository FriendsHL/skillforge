...
| **EVOLVE-JUDGE-GROUNDING** | 自进化判定与候选对靶优化（blog 复盘）。Phase 1 = 配对/comparative 判定（复用已有 perScenarioFlips 做 net-wins 判据，治绝对打分噪声→0 赢家），无 schema 改动；Phase 2+ grounding/refuter/held-out 列 roadmap | prd-ready（待 ratify） | [需求包](requirements/active/2026-06-17-EVOLVE-JUDGE-GROUNDING/index.md) | [MRD](requirements/active/2026-06-17-EVOLVE-JUDGE-GROUNDING/mrd.md) | [PRD](requirements/active/2026-06-17-EVOLVE-JUDGE-GROUNDING/prd.md) | [tech-design](requirements/active/2026-06-17-EVOLVE-JUDGE-GROUNDING/tech-design.md) | — |
