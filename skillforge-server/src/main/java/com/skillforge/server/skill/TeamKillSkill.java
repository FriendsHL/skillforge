 ...
 */
public class TeamKillSkill implements Skill {

    private static final Logger log = LoggerFactory.getLogger(TeamKillSkill.class);
    ...
    public TeamKillSkill(SessionService sessionService,
    ...
    public SkillResult execute(Map<String, Object> input, SkillContext context) {
        try {
            ...
            log.error("TeamKillSkill execute failed", e);
