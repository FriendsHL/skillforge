 ...
 */
public class TeamListSkill implements Skill {

    private static final Logger log = LoggerFactory.getLogger(TeamListSkill.class);

    private final SessionService sessionService;
    private final AgentRoster agentRoster;

    public TeamListSkill(SessionService sessionService, AgentRoster agentRoster) {
    ...
    public SkillResult execute(Map<String, Object> input, SkillContext context) {
        try {
            ...
            log.error("TeamListSkill execute failed", e);
