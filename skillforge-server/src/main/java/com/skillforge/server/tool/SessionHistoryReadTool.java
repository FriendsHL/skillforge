...
/** System-resident current-Session exact evidence reader Tool. */
public final class SessionHistoryReadTool extends AbstractSessionHistoryTool {

    private final HistoryToolInputValidator inputValidator;
    private final SessionHistoryQueryService queryService;

    public SessionHistoryReadTool(
    ...
    @Override public String getName() {
        return SessionHistoryToolSchemas.READ_NAME;
    }
    ...
    @Override public ToolSchema getToolSchema() {
        return SessionHistoryToolSchemas.read();
    }
    ...
    public SkillResult execute(Map<String, Object> input, SkillContext context) {
        ...
        try {
            ...
            SessionHistoryReadInput request = inputValidator.validateReadInput(input);
            ...
            return SkillResult.success(wireFormatter.format(queryService.read(scope, request)));
