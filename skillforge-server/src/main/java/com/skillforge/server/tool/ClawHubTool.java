 ...
 */
public class ClawHubTool implements Tool {

    private static final Logger log = LoggerFactory.getLogger(ClawHubTool.class);

    private final ClawHubClient client;
    private final ClawHubInstallService installService;

    public ClawHubTool(ClawHubClient client, ClawHubInstallService installService) {
        this.client = client;
    ...
    public ToolSchema getToolSchema() {
        ...
        properties.put("slug", Map.of(
                "type", "string",
                "description", "Tool slug (required for get_detail / scan / install)"
        ));
    ...
    public SkillResult execute(Map<String, Object> input, SkillContext context) {
        try {
            ...
            log.error("ClawHubTool execute failed", e);
