 ...
 */
public class RegisterScriptMethodSkill implements Skill {

    private static final Logger log = LoggerFactory.getLogger(RegisterScriptMethodSkill.class);
    ...
    public RegisterScriptMethodSkill(ScriptMethodService scriptMethodService, ObjectMapper objectMapper) {
