 ...
 */
public class RegisterCompiledMethodSkill implements Skill {

    private static final Logger log = LoggerFactory.getLogger(RegisterCompiledMethodSkill.class);
    ...
    public RegisterCompiledMethodSkill(CompiledMethodService compiledMethodService, ObjectMapper objectMapper) {
