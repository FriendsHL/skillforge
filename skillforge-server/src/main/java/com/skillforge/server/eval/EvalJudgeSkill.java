...
@Component
public class EvalJudgeSkill {

    private static final Logger log = LoggerFactory.getLogger(EvalJudgeSkill.class);

    private final LlmProviderFactory llmProviderFactory;
    private final AttributionEngine attributionEngine;
    private final String defaultProviderName;

    public EvalJudgeSkill(LlmProviderFactory llmProviderFactory,
